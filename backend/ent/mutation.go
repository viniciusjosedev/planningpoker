...
func (m *RoomMutation) SetHash(s string) {
	m.hash = &s
}

// Hash returns the value of the "hash" field in the mutation.
func (m *RoomMutation) Hash() (r string, exists bool) {
	v := m.hash
	if v == nil {
		return
	}
...
// OldHash returns the old "hash" field's value of the Room entity.
// If the Room object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RoomMutation) OldHash(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RoomMutation) Fields() []string {
	...
	if m.hash != nil {
		fields = append(fields, room.FieldHash)
	}
	return fields
}
